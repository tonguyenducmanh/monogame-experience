...
public class Slime
{
    ...
    public void Update(GameTime gameTime)
    {
        ...
        // Trong trò chơi, tốc độ khung hình có thể thay đổi tùy theo hiệu suất hệ thống, khiến khoảng thời gian cập nhật không nhất quán.  Nếu chúng ta chỉ đặt lại bộ đếm thời gian chuyển động về 0 sau mỗi chu kỳ chuyển động, chúng ta sẽ mất mọi thời gian dư thừa tích lũy vượt quá ngưỡng chuyển động.

        // Ví dụ:

        // Ngưỡng chuyển động của chúng tôi là 200ms.
        // Trò chơi chạy ở tốc độ 60 khung hình / giây (16,67 mili giây mỗi khung hình).
        // Sau 12 khung hình, chúng tôi đã tích lũy được 200,04ms.
        // Nếu chúng ta đặt lại về 0, chúng ta sẽ mất 0,04 mili giây.
        // Theo thời gian, những tổn thất nhỏ này có thể cộng lại và gây ra chuyển động không nhất quán.
        // Bằng cách trừ ngưỡng thay vì đặt lại về 0, chúng tôi "lưu trữ" thời gian dư thừa (0,04 mili giây trong ví dụ này) cho chu kỳ chuyển động tiếp theo.  Điều này đảm bảo rằng:

        // Chuyển động diễn ra chính xác với tần suất dự kiến, duy trì tốc độ trận đấu ổn định.
        // Độ mượt mà của chuyển động vẫn được giữ nguyên ngay cả khi trò chơi thỉnh thoảng bị rớt khung hình.
        // Người chơi trải nghiệm cùng một thời gian trong trò chơi bất kể hiệu suất phần cứng của họ như thế nào.
        // Kỹ thuật này là phương pháp tiêu chuẩn trong phát triển trò chơi, đặc biệt đối với các cơ chế nhạy cảm với thời gian như trò chơi nhịp điệu, hoạt ảnh và hệ thống chuyển động.  Đó là một giải pháp đơn giản giúp cải thiện đáng kể tính nhất quán của trò chơi.
